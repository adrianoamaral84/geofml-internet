                ...
                <form id="profile-form" action="{{ route('editUsuario') }}" method="POST">
                    ...
                    <div class="row form-group has-error">
                        <div class="col-8">
                            ...
                            <input type="text" class="form-control boxed @error('nome') is-invalid @enderror" value="{{ $usuario->nome }}" name="nome" id="nome" autofocus required maxlength="100" onpaste="return false;">
                            @error('nome')
