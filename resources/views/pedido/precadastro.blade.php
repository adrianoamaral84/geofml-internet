                    ...
                    <div class="row has-error">
                         ...
                         <div class="col-sm-4 col-md-4 col-lg-4 form-group ForcaOmPosto">
                            ...
                            <label class="control-label" id="nivel">{{ __('Posto / Graduação') }}</label>
                                <select name="posto" id="posto" class="custom-select mr-sm-2 @error('posto') is-invalid @enderror" autocomplete="off" @if($user->situacao_id == 2) readonly="readonly" tabindex="-1" aria-disabled="true" style="touch-action: none; pointer-events: none;" @endif>
                                <option value="" id="nivel">Selecione</option>
                     ...
                     <div class="row has-error">
                            ...
                            <div class="col-sm-4 col-md-4 col-lg-4 form-group">
                                ...
                                <select name="om" id="om" required="required" class="custom-select mr-sm-2 @error('om') is-invalid @enderror" autocomplete="off">
