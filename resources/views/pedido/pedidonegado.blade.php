...
<article class="items-list-page">
    <div class="title-search-block">
        <div class="title-block">
            <div class="row">
                <div class="col-md-6">
                    <h3 class="title"> Solicitações Negadas de Acesso</h3> 
                    <p class="title-description"> Usuários que tiveram seu acesso ao sistema negado! </p>
                </div>
            </div>
        </div>
    ...
    <a href="{{ route('lista.pedidos') }}"   class="btn btn-info btn-sm" style="color: #ffffff" title="Expirados">
    <i class="fas fa-check-square" style="color: #ffffff"></i>  Aguardando</a>
    <!--
    <a href="" class="btn btn-danger btn-sm" style="color: #ffffff" title="Aprovados">
                            ...
                            <div class="table-flip-scroll">
                                <table class="table table-striped table-bordered table-hover flip-content" id="tabela">
                                    ...
                                    <tbody>    
                                            ...
                                            @if ($consulta->count() == 0)
                                            <tr>
                                                <td colspan="7" style="text-align: center;"><small>Nenhum registro encontrado</small></td>
                                            </tr>
                                            @else
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <h6><span class="badge badge-danger"> Negado</span></h6>
                                                </td>
...
<script type="text/javascript">
   ...
   buttons: [
            ...
            {
                extend: 'excelHtml5',              
                title: 'GEOFML - Usuarios Negados do Sistema'
            },
            {
                extend: 'pdfHtml5',
                title: 'GEOFML - Usuarios Negados do Sistema'
