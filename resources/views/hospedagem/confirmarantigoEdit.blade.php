    ...
    <section class="section">
                    ...
                    <div class="card-block">
                        <section class="example">
                            <div class="table-flip-scroll">
                                <form id="password-form" action="{{ route('hospede.storeEdit.edita') }}" method="POST">
                                    @csrf
        ...
        <div class="row has-error">
            ...
            <div class="form-group col-sm-12 col-md-12 col-lg-6">
                            ...
                            <input type="hidden" name="cod" value="{{ $totalValor }}">
                    <input type="hidden" name="id" value="{{$consulta->id}}">
                    <input type="hidden" name="valortarifa" value="{{ $valorTarifa }}">
                            ...
                            @enderror
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12 col-md-12 col-lg-12">
                                            ...
                                            <a href="{{ route('hospede.solicitarinscricao') }}" class="btn btn-danger rounded-s"><i class="fas fa-window-close fa-sm"></i>  Cancelar </a>

                                            <button type="submit" class="btn btn-primary rounded-s"><i class="fas fa-check-circle"></i> Confirmar Pedido! </button>
