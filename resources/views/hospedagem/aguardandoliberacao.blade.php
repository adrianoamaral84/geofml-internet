        ...
        <div class="title-block">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <small>Lista de Usuários aguardando Liberação da Unidade </small> 
                </div>
            </div>
        </div>
                    ...
                    <div class="card-block">
                        <section class="example">
                            <div class="table-flip-scroll">
                                ...
                                <a href="{{ route('hospedagem.index')}}" title="Aguardando Aprovação" class="btn btn-success btn-xl" style="color: #fff">
                                   <i class="fas fa-angle-double-up"></i>
                               Ver Aguardando Aprovação
                                </a>
                                    ...
                                    <tbody>                                        
                                            ...
                                            <tr>
                                               ...
                                               <td> {{$item->user->posto->sigla}} </td>
                                                <td> 
                                                <a href="{{ route('hospedagem.verdados_aguardando_liberacao', ['id' => Crypt::encrypt($item->id)]) }}" title="Ver Dados">            
                                                        {{$item->user->name}}
                                                    </a> 
                                                </td>
