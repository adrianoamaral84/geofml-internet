...
|:-------------:|:-------------:|:-------------:|:--------:|:-------:|
|{{\Carbon\Carbon::parse($data_inicio)->format('d/m/Y')}}|{{\Carbon\Carbon::parse($data_termino)->format('d/m/Y')}}|{{ $unidade }}|R$ {{ number_format($valortarifa, 2, ',', '.') }}|R$ {{ number_format($valor, 2, ',', '.') }}|
