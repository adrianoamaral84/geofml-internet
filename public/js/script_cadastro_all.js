...
function validaPostoSituacaoTodos(ufId, cidadeFieldName){
   
   //alert(ufId);
    if(ufId) {
        $.ajax({
            url: $host+'/cascade/carregarPostoSituacao/all/'+ufId,
            type: "GET",
            dataType: "json",
            success:function(data) {
...
$(document).ready(function(){
    ...
    $('select[name="grupodestinacao"]').on('change', function() {
        ...
        //alert('ok');
        //$('#cidade').prop('readonly', null);
        validaGrupo(ufId, 'grupodestinacao');
    });
    /* */
    //////////////////////////////////////////////
    ...
    */
    ...
    $('#posto').on('change', ()=>{
        document.getElementById("dtUltPromo").value = "";
        $('#documento_verso').attr('required', true);
        $('#documento').attr('required', true);
        alert('Precisa anexar novo documento');

        //document.getElementById("idtMil").value = "";
    });
...
//////////////////////////////////////////////////////////////////
   ...
   var OMid = $('select[name="situacao"] option:selected').val();
    if (OMid != '') {
        //alert(Om_id);
        validaPostoSituacaoTodos(OMid, 'posto');
        //validaPosto(OMid, 'posto');
    }
    ...
    if($('select[name="situacao"] option:selected').val() != '') {
        ...
        //alert(Om_id);
        validaPostoSituacaoTodos(Om_id, 'posto');
        //validaPosto(Om_id, 'posto');
    }
