...
class PedidoHospedagemNegado extends Mailable
{
     ...
     * @return void
     */
    public function __construct($hospede)
    {
    ...
    public function build()
    {
        ...
        $mensagem = \App\GerenciarEmails::where('id', 10)->first();
        ...
        return $this->markdown('mail.pedidoHospedagemNegado')->with([
